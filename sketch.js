...
function setup() {
	...
	box1= createSprite(width/2,650,200,20,{isStatic:true, restitution: 0.3});
	box1.shapeColor=color("yellow")

	box2=createSprite(290,620,20,100,{isStatic:true, restitution: 0.3});
	box2.shapeColor=color("yellow")

	box3=createSprite(510,620,20,100,{isStatic:true, restitution: 0.3});
